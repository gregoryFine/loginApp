...
public class FactoryFragment extends Fragment {
    ...
    public static FactoryFragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.v("Factory", "mParam1:" + mParam1+ "mParam2:" + mParam2); //测试创建fragment的工厂方法执行时，传入参数是否能被接受到
        Log.v("Factory", String.valueOf(((jumpActivity)getActivity()).getCount()));//测试fragment得到所在activity 中的变量
